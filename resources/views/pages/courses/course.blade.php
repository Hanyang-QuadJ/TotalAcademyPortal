    ...
    <div id="page-content-wrapper" style="margin-top: 50px;">
        <div class="container-fluid">
            <div class="submit-btn">
                <a href="/course/create"><button class="btn btn-default btn-block">수업등록</button></a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        @foreach($courses as $course)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/course/{{$course->id}}/edit"><button class="btn btn-default">수정</button></a>
            ...
            <div class="submit-btn">
                <a href="/semester/create"><button class="btn btn-default btn-block">학기등록</button></a>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <table id="semester-table" class="table table-striped table-bordered" cellspacing="0">
                        ...
                        @foreach($semesters as $semester)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success">자세히</button>
                                    <a href="/semester/{{$semester->id}}/edit"><button class="btn btn-default">수정</button></a>
